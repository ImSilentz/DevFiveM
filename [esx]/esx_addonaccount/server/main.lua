...
MySQL.ready(function()
	...
	for i = 1, #result, 1 do
		...
		if shared == 0 then
			...
			if #result2 == 0 then
				MySQL.insert.await('INSERT INTO addon_account_data (account_name, money, owner) VALUES (@account_name, @money, NULL)', {
					['@account_name'] = name,
					['@money'] = 0
				})
...
AddEventHandler('esx:playerLoaded', function(playerId, xPlayer)
	...
	for i = 1, #AccountsIndex, 1 do
		...
		if account == nil then
			MySQL.insert('INSERT INTO addon_account_data (account_name, money, owner) VALUES (@account_name, @money, @owner)', {
				['@account_name'] = name,
				['@money'] = 0,
