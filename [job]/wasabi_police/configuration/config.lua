...
Config.Locations = {
    LSPD = {
        ...
        bossMenu = {
            ...
            coords = vec3(447.9235, -973.1188, 30.6896), -- Location of boss menu (If not using target)
            label = '[E] - Ouvrir Menu Patron', -- Text UI label string (If not using target)
        ...
        armoury = {
            ...
            weapons = {
                [0] = { -- Grade number will be the name of each table(this would be grade 0)
                    ['WEAPON_COMBATPISTOL'] = { label = 'Pistolet de Combat', multiple = false, price = 75 }, -- Set price to false if undesired
                    ['WEAPON_NIGHTSTICK'] = { label = 'Matraque', multiple = false, price = 50 },
...
--                    ['armour'] = { label = 'Bulletproof Vest', multiple = false, price = 100 }, -- Example
                ...
                [1] = { -- This would be grade 1
                    ['WEAPON_COMBATPISTOL'] = { label = 'Pistolet de Combat', multiple = false, price = 150 },
                    ['WEAPON_NIGHTSTICK'] = { label = 'Matraque', multiple = false, price = 50 },
...
--                    ['armour'] = { label = 'Bulletproof Vest', multiple = false, price = 100 }, -- Example
                ...
                [2] = { -- This would be grade 2
                    ['WEAPON_COMBATPISTOL'] = { label = 'Pistolet de Combat', multiple = false, price = 150 },
                    ['WEAPON_NIGHTSTICK'] = { label = 'Matraque', multiple = false, price = 50 },
                    ['WEAPON_ASSAULTRIFLE'] = { label = 'M4', multiple = false, price = 1100 },
--                    ['ammo-9'] = { label = '9mm Ammo', multiple = true, price = 10 }, -- Example
...
--                    ['armour'] = { label = 'Bulletproof Vest', multiple = false, price = 100 }, -- Example
        ...
        cloakroom = {
            ...
            jobLock = 'police', -- Allow only one of Config.policeJob listings / Set to false if allow all Config.policeJobs
            coords = vec3(456.6080, -988.6066, 30.6896), -- Coords of cloakroom
            label = '[E] - Se Changer', -- String of text ui of cloakroom
        ...
        vehicles = { -- Vehicle Garage
            ...
            zone = {
                coords = vec3(458.5994, -1017.1238, 28.2026), -- Area to prompt vehicle garage
